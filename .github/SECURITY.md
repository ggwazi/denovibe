...
3. Fill in the details: affected versions, steps to reproduce, and potential impact.
...
- Self-inflicted misconfigurations (e.g., running as root in production)
- Social engineering attacks
- Denial of service through resource exhaustion on systems you control
